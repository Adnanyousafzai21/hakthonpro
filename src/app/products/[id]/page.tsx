                  ...
                  <div className="flex mt-2 items-center border-b-2 pb-2  border-gray-100 ">
                    <div className="flex">
                      ...
                      {result.color.map((color: string) => (
                        <button
                          ...
                          className={`border-2 border-gray-300 ml-1 bg-${color} rounded-full w-6 h-6 focus:outline-none`}
                        />
                      ))}
                    </div>
                    <div className="flex ml-6 items-center">
                      ...
                      <div className="relative">
                        <select onChange={(e)=>setdata({...data, size:e.target.value})} className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10">
